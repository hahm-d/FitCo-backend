...
4.times do |i|
    ...
    samplePost.image.attach(io: File.open("/Users/daniel/Flatiron/personal/FitCo/FitCo-backend/samples/post#{i+1}.png"), filename: "post#{i+1}.png", content_type: 'image/png')
